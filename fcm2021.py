...
if acc > max_acc:
	with open("fcm2021.pkl", "wb") as f: 
		pickle.dump(fcm, f)
	with open("fcm2021results.pkl", "wb") as f: 
		pickle.dump(label, f) 
	max_acc = acc
	max_swap = 0
...
if acc > max_acc:
	...
	max_swap = 3
	print('salvo:',i,acc,max_swap)
with open("fcm2021results.pkl", "rb") as f: 
    results = pickle.load(f)
r=0
results_dir='lsdoltts2021fcm/mlpLT/longterm/'
for i in os.listdir('groundtruth2021'): 
	with open("groundtruth2021/"+i+"/groundtruth.txt") as f:
		y=f.readlines()
